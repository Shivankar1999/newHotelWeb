...
const Fotter = () => {
  return (
    <div className={styles.fotterBox}>
      ...
      <div className={styles.ConnectMedia}>
        <a rel="noreferrer" href="https://www.meta.com" target="_blank">
          Meta{' '}
          <svg
        ...
        <a rel="noreferrer" href="https://www.linkdin.com" target="_blank">
          Linkdin{' '}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
